...
public class Help {
	...
	public enum sectionName { 
		DASHBOARD, ADDDECK_COLORS, ADDDECK_DETAILS, DECKLIST, 
		VIEWDECK, VIEWDECK_OPTIONS, VIEWDECK_STATS, VIEWDECK_GAMES, 
		VIEWDECK_ALTERATIONS, GAME, ALTERDECK, ALTERDECK_COLORS, 
		ALTERDECK_DETAILS, LIVEGAME, LIVEGAME_ADMIN, LIVEGAME_ADMIN_INVITE, 
		INITGAME, JOINGAME, VIEWSTATS, VIEWSTATS_WITH, VIEWSTATS_AGAINST
		};
